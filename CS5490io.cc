// modified to use MRAA instead of wiringPi
...
void DriverVersion(const Nan::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    std::string version("CS5490io v1.0");
...
//    pinModeAlt( 8, 0b100 ); //"alt0" TODO:
//    pinModeAlt( 10, 0b100 ); //"alt0" TODO:
...
{
    if (info.Length() != 1)
        errormsg("Expected 1 argument - value");
